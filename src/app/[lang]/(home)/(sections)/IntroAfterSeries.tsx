    ...
    style={{
      maxWidth: '1145px'
        ...
        <div className="row items-center">
          ...
          <div className="px-2.5" style={{width:'55%'}}>
            <div className="pl-0 lg:pl-9" style={{maxWidth:'516px'}}>
              <div className="serif mb-1 text-center text-[48px] leading-[1.2] text-major-700">Dedicated <i>to</i> bring<br/>Your Dreams <i>to</i> Life</div>
              <div className="text-center text-[15px] leading-[1.8] text-gray-700">Each of the eight series  is unique in its style and intended use.Whether your passion is pleasure cruising or offshore exploring, there is a Horizon series model designed with you in mind.</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="relative mb-[60px] h-[608px] w-full">
        <div className="absolute left-0 top-0 z-10 flex h-full w-full flex-col items-center justify-center p-5 text-center text-white">
          <div className="serif text-[32px] font-300 italic">
            <LinkWithLang href="/about/innovation" lang={props?.lang}>Innovation of Horizon</LinkWithLang>
          </div>
