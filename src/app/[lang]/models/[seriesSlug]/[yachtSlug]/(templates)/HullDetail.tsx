  ...
  return <Suspense fallback={null}>
    <div className={twMerge('', className)}>
      ...
      style={{
        ...
        <div className="absolute left-0 top-0 flex h-full w-full flex-col overflow-auto bg-golden-300 pb-10">
              ...
              switch(activeSection){
                ...
                case 'VR':
                  return <div className="relative z-10 grow">
                    <iframe className="absolute left-0 top-0 z-10 h-full w-full" src={props.vrEmbedUrl} frameBorder="0"></iframe>
                  </div>
